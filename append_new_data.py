...
def append_new_data():
    """Append new scraped data to existing BOOK_DATABASE"""
    print("🔄 Appending new scraped data to existing database...")
    ...
    # Find the BOOK_DATABASE object and the last entry
    ...
    # Look for the last entry pattern: number: { ... },
    ...
    print(f"✅ Appended {len(new_books)} new books to database")
