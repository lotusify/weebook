...
def debug_html_structure():
    ...
    print("Debugging VPP Hong Ha HTML structure...")
    
    url = "https://vpphongha.vn/collections/van-phong-pham"
    ...
    try:
        ...
        with open('vpphongha_full.html', 'w', encoding='utf-8') as f:
            f.write(soup.prettify())
        print("Saved full HTML to vpphongha_full.html")
        ...
        print("\n=== DEBUG COMPLETE ===")
        print("Check vpphongha_full.html for full HTML structure")
