...
def reduce_office_supplies():
    """Reduce office supplies to 30-50 items"""
    ...
    # 2. Count current office supplies
    ...
    # 3. Keep only first 40 office supplies (good middle ground)
    if len(matches) > 40:
